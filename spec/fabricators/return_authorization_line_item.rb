Fabricator(:return_authorization_line_item, class_name: JCS::ReturnAuthorizationLineItem) do
  element {{ line_no: sequence(:line_no, 00001),
             ...
             ship_date: Faker::Date.between(Date.today, Date.today + 2000 ).strftime.gsub("-",""),
             failure_date: Faker::Date.between(Date.today, Date.today + 2000 ).strftime.gsub("-",""),
             failure_description: Faker::Lorem.sentence }}
end
